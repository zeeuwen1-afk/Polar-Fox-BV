...
| 2   | Schermafbeeldingen HPP-Dashboard (2×)                                                | `public/images/cases/` (zie README daar), daarna `placeholder: false` in `cases.ts` | gedaan (25 sep 2026, 1 beeld)    |
| 3   | Schermafbeeldingen YogaCompany.eu (2×)                                               | `public/images/cases/`                                                              | gedaan (25 sep 2026, 1 beeld)    |
